...
public class NikeActivity extends AppCompatActivity {
    ...
    private void Anhxa() {
        toolbardt = (Toolbar) findViewById(R.id.toolbarnike);
        lvdt = (ListView) findViewById(R.id.listviewnike);
        mangdt = new ArrayList<>();
        nikeAdapter = new NikeAdapter(getApplicationContext(),mangdt);
        lvdt.setAdapter(nikeAdapter);
